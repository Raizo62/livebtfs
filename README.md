...
```bash
    $ wget https://kali.download/base-images/kali-2026.1/kali-linux-2026.1-live-amd64.iso.torrent
```
...
```
  ...
  * Mount the VM
```bash
    $ livebtfs -f kali-linux-2026.1-live-amd64.iso.torrent mnt/kali
```
...
```bash
    $ qemu-system-x86_64 -m 1024 -cdrom mnt/kali/kali-linux-2026.1-live-amd64.iso -enable-kvm -usb -device usb-tablet
```
